export const dropFromRouteText = "Вернуть в парк";
export const setToRouteText = "Выехать на маршрут";
export const chooseRouteText = "Выбрать маршрут";

export const checkBusSufficiency = "Проверить достаточность автобусов";
